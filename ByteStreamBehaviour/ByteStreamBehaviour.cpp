// ByteStreamBehaviour.cpp
//
// This program creates a IMFByteStream and test various edge cases in order
// to determine its behaviour. This is so that I can figure out how to copy
// its behaviour in my own IMFByteStream implementation.
//
// Chris Pearce, 1 Feb 2013.
...
int _tmain(int argc, _TCHAR* argv[])
{
  ...
  /*
  // Creates an IMFByteStream wrapping an IStream. This doesn't have the same
  // behaviour as WMF's network reading IMFByteStream, don't try to copy it.
